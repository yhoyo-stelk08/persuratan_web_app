...
export default function SuratKeluarIndex({
    ...
    const dataSuratURL = useMemo(() => {
        const url = new URL(route("surat-keluar.index"));
                        ...
                        <div className="flex flex-col justify-start items-center sm:flex-row mt-6 w-full">
                            <div className="relative text-sm text-gray-800 col-span-3 w-1/2">
                                ...
                                <input
                                    ...
                                    type="text"
                                    autoComplete="off"
                                    placeholder="Cari naskah keluar..."
                                    id="search"
                            ...
                            <div className="w-1/2">
                                <TambahSuratLink
                                    routeName="surat-keluar.create"
                                    className="w-full"
                                >
                                    Register Naskah Keluar
                                </TambahSuratLink>
                            </div>
                        </div>
                            ...
                            <div className="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                                    ...
                                    <TableSurat
                                        ...
                                        deleteRoute="surat-keluar.destroy"
